...
<script type="text/javascript" src="{{asset('assets/js/plugins/pickers/picker_date.js')}}"></script> --}}
...
<script type="text/javascript" src="{{asset('js/proses_data_saleh.js')}}"></script>
