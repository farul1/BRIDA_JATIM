    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-info" onclick="tambah_data_berita('{{csrf_token()}}', '#ModalBiru')">Tambah Data
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (strlen($r->description) >=100) {
                                        $str = substr($r->description, 0, 170) . ' ...';
                                    }
                                    echo $str;
                                    ?>
                                </td>
                                ...
                                <td>
                                    @if(isset($r->gambar))
                                    <img src="{{asset('file_upload/berita/'.$r->gambar)}}" alt="" style="width:60%;">
                                    @else
                                    Tidak ada Gambar
                                    @endif
                                </td>
                                ...
                                <td>
									...
									ubah_data_berita('{{csrf_token()}}', '{{ $id }}', '#ModalTeal')
									" id="modal_update_profilkat" title="Ubah" class="btn bg-teal-400 btn-xs btn-block">
                                            ...
                                            <li>
                                                <button type="button"
                                                    onclick="hapus_data_berita('{{csrf_token()}}','{{ $r->id }}')"
