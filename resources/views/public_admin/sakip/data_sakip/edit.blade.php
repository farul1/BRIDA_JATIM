        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_sakip_data_ubah', $sakip->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        @csrf
                        <div class="modal-body">
                            <div class="form-group status_lengkap row">
                                ...
                                <div class="col-lg-8"> 
                                    <input required type="text" class="form-control" value="{{ old('judul', $sakip->judul) }}" name="judul" id="judul">  
                                </div>
                            </div> 
                                ...
                                <div class="col-lg-8"> 
                                    <select class="form-control select22" id="id_kategori" name="id_kategori" required> 
                                        ...
                                        @foreach($sakip_kategori as $r)
                                            <option value="{{ $r->id }}" {{ $r->id == $sakip->id_kategori ? 'selected' : '' }}>
                                                {{ $r->nama_kategori }}
                                            </option>
                                        @endforeach
                                    </select> 
                            ...
                            <div class="form-group status_lengkap row">
                                <label for="keterangan" class="col-lg-3 control-label" style="text-align: right;">
                                    Keterangan : <!-- tanpa required -->
                                </label>
                                <div class="col-lg-8"> 
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="4" placeholder="Opsional">{{ old('keterangan', $sakip->keterangan) }}</textarea>
                                </div>
                            </div> 
                            ...
                            <div class="form-group status_lengkap row">
                                ...
                                <div class="col-lg-8"> 
                                    <input type="file" class="form-control" name="file_upload" id="file_upload" accept=".pdf,.doc,.docx">  
                                    @if($sakip->file)
                                        <small>File saat ini: <a href="{{ asset($sakip->file) }}" target="_blank">Download file</a></small>
                                    @endif
                                </div>
                            </div> 
                            ...
                            <div class="form-group status_lengkap row">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($sakip->gambar)
                                        <br>
                                        <img src="{{ asset($sakip->gambar) }}" alt="Gambar saat ini" style="max-width: 150px; border-radius: 4px; margin-top: 5px;">
