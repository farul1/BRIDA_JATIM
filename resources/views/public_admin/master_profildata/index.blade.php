    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            <div class="panel-heading">
                <h6 class="panel-title">Data Profil </h6>
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-info" onclick="tambah_data_profildata('{{csrf_token()}}', '#ModalBiru')">Tambah Data
                    ...
                    <table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($r->file))
                                    <a target="_blank" href="{{ asset('file_upload/profil_data/file/'.$r->file) }}">{{ $r->file }}</a>
                                    @else
                                    Tidak ada File
                                    @endif
                                </td>
                                <td>{{ $r->profilkategori?->nama_kategori ?? 'Tidak Ada Kategori' }}</td>
                                <td>
									...
									ubah_data_profildata('{{csrf_token()}}', '{{ $id }}', '#ModalTeal')
									" id="modal_update_profilkat" title="Ubah" class="btn bg-teal-400 btn-xs btn-block">
                                            ...
                                            <li>
                                                <button type="button"
                                                    onclick="hapus_data_profildata('{{csrf_token()}}','{{ $r->id }}')"
