    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            <div class="panel-heading">
                <h6 class="panel-title">Data Foto </h6>
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-info" onclick="tambah_data_foto('{{csrf_token()}}', '#ModalBiru')">Tambah Data
                    ...
                    <table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{@$r->galeri->judul}}</td>
                                <td><img src="{{asset('file_upload/foto/'.$r->gambar)}}" alt="" style="width:30%;"></td>
                                ...
                                <td>
                                    <div class="btn-group btn-block btn-group-velocity">
                                        ...
                                        <li>
                                            <button type="button" onclick="ubah_data_foto('{{ csrf_token() }}', '{{ $id }}', '#ModalTeal')"
                                            ...
                                            <li>
                                                <button type="button"
                                                    onclick="hapus_data_foto('{{csrf_token()}}','{{ $r->id }}')"
