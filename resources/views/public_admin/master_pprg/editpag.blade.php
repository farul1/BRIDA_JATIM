    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            <div class="panel-heading">
                <h6 class="panel-title">UBAH PAG</h6>
            ...
            <form action="{{route('simpan_ubah_pag',$pag->id)}}" method="post">
                @csrf
                <div class="panel-body">
                            ...
                            <div class="row justify-content-md-between">
                                <div class="col-md-4 col-md-offset-1">
                                    <div class="">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="kodeprogram" value="{{$pag->kode_program}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-md-between">
                                <div class="col-md-4 col-md-offset-1">
                                    <div class="">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="jumlah_anggaran" id="dengan-rupiah" value="{{$pag->jumlah_anggaran}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <br>
                    <input type="hidden" name="idgap" value="{{$gap->id}}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                                                ...
                                                                <div class="panel-body" id="rencanaaksi">
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-10">
                                                                                <input type="text" class="form-control" id="input-rupiah" name="input[]" value="{{$a->input}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-10">
                                                                                <textarea name="output[]" class="form-control" rows="3">{{$a->output}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-10">
                                                                                <textarea name="outcome[]" class="form-control" rows="3">{{$a->outcome}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    function tambahfieldrencana(){
        ...
        '<div class="col-lg-10">' +
            '<div class="input-group">' +
                '<textarea name="rencanaaksi[]" class="form-control" rows="3"></textarea>' +
