        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi">
                    <form id="formTambahMasterRS" method="post" action="{{ route('brida_kategori.store') }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <input required type="text" class="form-control" value="{{ old('nama_kategori') }}" name="nama_kategori" id="nama_kategori" >
                                    @error('nama_kategori')
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" value="{{ old('link') }}" name="link" id="link" >
