    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            <div class="panel-heading">
                <h6 class="panel-title">Kategori BRIDA</h6>
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-info" onclick="tambah_data_brida_kategori('{{csrf_token()}}', '#ModalBiruSm')">Tambah Data
                                ...
                                <td>
                                    <div class="btn-group btn-block btn-group-velocity">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button type="button" onclick="ubah_data_brida_kategori('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
                                                    " id="modal_update_brida_kategori" title="Ubah" class="btn bg-teal-400 btn-xs btn-block">
                                                    <i class="glyphicon glyphicon-edit"></i>Ubah</button>
                                            </li>
                                            <li>
                                                <button type="button"
    onclick="hapus_data_brida_kategori('{{csrf_token()}}','{{ $r->id }}')"
    title="Hapus"
