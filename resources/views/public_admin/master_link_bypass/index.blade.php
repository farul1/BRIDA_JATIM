    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-indigo">
            <div class="panel-heading">
                <h6 class="panel-title">Data Link Bypass</h6>
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-info" onclick="tambah_data_linkbypass('{{csrf_token()}}', '#ModalBiru')">Tambah Data
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
									...
									ubah_data_linkbypass('{{csrf_token()}}', '{{ $id }}', '#ModalTeal')
									" id="modal_update_profilkat" title="Ubah" class="btn bg-teal-400 btn-xs btn-block">
                                            ...
                                            <li>
                                                <button type="button"
                                                    onclick="hapus_data_linkbypass('{{csrf_token()}}','{{ $r->id }}')"
